...
class UnicodeAcAutomation():
    ...
    def contain_key(self, string):
        status, ret = self.matchOne(string)
        if status:
            if ret == string:
                return True
        return False
...
def main2():
    ...
    ac.insert(u"abcde")
    ac.build_automation()
    print ac.matchOne(u"12")
    print ac.matchOne(u"1234")
    print ac.matchOne(u"12345")
    print ac.matchOne(u"abcdeabcde")
    print ac.contain_key(u"abcdefg")
    print ac.contain_key(u"abcde")
    print ac.contain_key(u"abcd")
